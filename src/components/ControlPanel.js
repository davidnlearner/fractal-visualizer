...
import RandomButton from './RandomizerButton';
...
const ControlPanel = () => {
    ...
    return (
        <div className="slide-container">
            ...
            <Control componentId='background-color' label='Background Color' value={context.backgroundColor} changeFunction={context.setBackgroundColor} controlType="color" />
            <Control componentId='edge-length' label='Edge Length' value={context.edgeLength} changeFunction={context.setEdgeLength} controlType="range" min='50' max={context.fractalType === 'tree' ? '200' : '350'} step='1' />
